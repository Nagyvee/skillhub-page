...
export default function AccreditedPage() {
    const courses = accredited.courses
        ...
        <main>
            ...
            <section className="py-16 lg:py-24 bg-background">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <AccreditedGrid courses={courses as any} pricingDisplay={accredited.shared.pricing.display} />
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex flex-wrap gap-4 justify-center">
                                    ...
                                    <Button size="lg" variant="outline" asChild>
                                        <Link href="/learnerships/bootcamps">View Bootcamps</Link>
                                    </Button>
                                </div>
                            </div>
                        </div>
