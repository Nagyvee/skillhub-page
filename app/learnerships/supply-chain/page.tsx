...
export const metadata = {
    title: "Supply Chain Learnerships | SkillHub International",
    description: "QCTO-accredited learnership programmes in supply chain, procurement, transport, and logistics. NQF Levels 5–7.",
    alternates: { canonical: "https://www.skillhub.africa/learnerships/supply-chain" },
}

export default function SupplyChainLearnershipsPage() {
    return (
        <main>
            <Navbar />
