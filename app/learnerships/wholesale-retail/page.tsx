...
export const metadata = {
    title: "Wholesale & Retail Qualifications | SkillHub International",
    description: "QCTO/SAQA accredited wholesale and retail qualifications. Nationally recognised programmes for retail professionals across South Africa.",
    alternates: { canonical: "https://www.skillhub.africa/learnerships/wholesale-retail" },
}

export default function WholesaleRetailPage() {
    const courses = wholesaleRetail.courses
                    ...
                    <MotionDiv variants={fadeInUp} className="relative overflow-hidden rounded-3xl border border-border/50 bg-card p-8 lg:p-12">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-lg text-muted-foreground mb-6 max-w-3xl">
                                Nationally recognised occupational certificates and qualifications
                                registered with QCTO and SAQA — designed to build practical,
                                work-ready skills for the wholesale and retail sector across
                                South Africa.
                            </p>
                            <div className="flex flex-wrap items-center gap-6 text-sm text-muted-foreground">
                                ...
                                <span className="flex items-center gap-2">
                                    ...
                                    {wholesaleRetail.shared.pricing.display} · Payment plans available
                                </span>
                            </div>
                        </div>
                    </MotionDiv>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    {courses.length > 0 ? (
                        <AccreditedGrid
                            ...
                            pricingDisplay={wholesaleRetail.shared.pricing.display}
                            basePath="/learnerships/wholesale-retail"
                        />
                    ) : (
                        <div className="rounded-2xl border border-dashed border-border/60 bg-card/50 py-16 text-center">
                            ...
                            <h3 className="mt-4 text-lg font-semibold text-foreground">
                                Wholesale &amp; retail qualifications coming soon
                            </h3>
                            <p className="mt-2 text-sm text-muted-foreground">
                                Our wholesale and retail programmes are being finalised. Check back shortly.
                            </p>
                        </div>
                    )}
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex flex-wrap gap-4 justify-center">
                                    ...
                                    <Button size="lg" variant="outline" asChild>
                                        <Link href="/learnerships/business">View Business Qualifications</Link>
                                    </Button>
                                </div>
                            </div>
                        </div>
